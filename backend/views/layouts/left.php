...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <form action="/admin/search/index" method="get" class="sidebar-form">
            <div class="input-group">
                <input type="text" name="Buy[code]" class="form-control" placeholder="搜尋證券"/>
        ...
        <?php
            ...
            'items' => [
                ...
                ['label' => '搜尋','linkOptions' => ['class' => 'treeview-menu'], 'icon' => 'fa fa-search', 'url' => ['/search/index']],
//                ['label' => '新聞','linkOptions' => ['class' => 'treeview-menu'], 'icon' => 'fa fa-bullhorn', 'url' => ['/']],
            ...
            'items' => [
                ...
                ['label' => '收藏','linkOptions' => ['class' => 'treeview-menu'], 'icon' => 'fa fa-book', 'url' => ['/collect/index','clear-state' => 1]],
