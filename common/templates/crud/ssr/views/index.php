...
use <?= $generator->indexWidgetType === 'grid' ? "common\components\yii2GridViewState\widgets\GridView" : "yii\\widgets\\ListView" ?>;
...
?>
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)) ?>-index  well well-sm well-white">
